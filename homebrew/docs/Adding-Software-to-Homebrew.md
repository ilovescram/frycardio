...
1. Try installing your formula using `brew install --build-from-source <formula>`, where _\<formula>_ is the name of your formula. If any errors occur, correct your formula and attempt to install it again. The formula installation should finish without errors by the end of this step.
