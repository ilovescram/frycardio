...
The Lead Maintainers may also support _ad hoc_ awards; if you believe that your proposed expense would advance Homebrew's project goals these should be sent to [OpenCollective](https://opencollective.com/homebrew) to be approved by Lead Maintainers.

See [Expense and Reimbursement Policy's _Getting Reimbursed_ section](Expense-and-Reimbursement-Policy.md#getting-reimbursed) for instructions how to submit expenses approved for the following sections.
...
See [Expense and Reimbursement Policy's _Getting Reimbursed_ section](Expense-and-Reimbursement-Policy.md#getting-reimbursed) for instructions how to seek approval for travel and submit approved expenses.
